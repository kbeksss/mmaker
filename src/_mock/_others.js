...
export const _pricingPlans = [
  {
    subscription: 'Free',
    price: 'free',
    lists: ['Basic Analytics', 'AI Support'],
    labelAction: 'Select Plan',
  },
  {
    subscription: 'Essential',
    price: '$89',
    lists: ['Automated Liquidity', 'Real-Time Analytics', 'Custom Strategies', 'Priority Support'],
    labelAction: 'Select Plan',
  },
  {
    subscription: 'Expert',
